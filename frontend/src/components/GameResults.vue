...
function getResultBadgeClass(result: string) {
  switch(result?.toLowerCase()) {
    case 'g': case 'galibiyet':
      return 'bg-green-100 text-green-800';
    case 'm': case 'mağlubiyet':  
      ...
      <table class="w-full text-sm">
        <thead>
          <tr class="bg-gray-50 border-b border-gray-100">
            ...
            <th class="text-left py-3 px-4 font-medium text-gray-600">Ev Sahibi</th>
            <th class="text-center py-3 px-4 font-medium text-gray-600">Skor</th>
            <th class="text-left py-3 px-4 font-medium text-gray-600">Deplasman</th>
            <th class="text-center py-3 px-4 font-medium text-gray-600">Sonuç</th>
          </tr>
        </thead>
        <tbody>
          <tr 
            ...
            :class="[
              ...
              (game.isGoztepeHome || game.isGoztepeAway) ? 'bg-goztepe-red bg-opacity-5' : ''
            ]"
          >
            ...
            <td class="py-3 px-4">
              <span :class="game.isGoztepeHome ? 'font-semibold text-goztepe-red' : 'text-gray-900'">
                {{ game.homeTeam }}
              </span>
            </td>
            ...
            <td class="py-3 px-4">
              <span :class="game.isGoztepeAway ? 'font-semibold text-goztepe-red' : 'text-gray-900'">
                {{ game.awayTeam }}
              </span>
            </td>
            <td class="py-3 px-4 text-center">
